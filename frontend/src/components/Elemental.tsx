...
import "../css/Elemental.scss";
import { Element } from "../../../shared/types/game-types";

export default function Elemental({ element }: { element: Element }) {
  if (element === "Fire")
    return (
      <img className="elemental-avatar" alt="elemental avatar" src={Fire} />
    );
  else if (element === "Water")
    return (
      <img className="elemental-avatar" alt="elemental avatar" src={Water} />
    );
  else if (element === "Earth")
    return (
      <img className="elemental-avatar" alt="elemental avatar" src={Earth} />
    );
  else if (element === "Air")
    return (
      <img className="elemental-avatar" alt="elemental avatar" src={Air} />
    );
  else return null;
}
